...
public abstract class BaseGameActivity extends AppCompatActivity {
    ...
    private void goToWinnerScreen(String amount) {
        try {
            ...
            PlayerProgress.onGameFinished(BaseGameActivity.this, true, prize, PlayerStats.getBestStreak(BaseGameActivity.this), usedAllHelps());
        } catch (Exception ignored) {}
        ...
        (new Handler()).postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    PlayerProgress.onGameFinished(BaseGameActivity.this, false, prize, PlayerStats.getBestStreak(BaseGameActivity.this), usedAllHelps());
                } catch (Exception ignored) {}
                stopSound(mpSound);
                            ...
                            if (!EXITING) {
                                try {
                                    ...
                                    PlayerProgress.onGameFinished(BaseGameActivity.this, false, safeHavenPrize,
                                        PlayerStats.getBestStreak(BaseGameActivity.this), usedAllHelps());
                                } catch (Exception ignored) {}
                            }
                            showInterstitialAd();
                            break;
